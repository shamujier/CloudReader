...
public interface HttpClient {
    ...
    class Builder {
        ...
        public static HttpClient getHost() {
            return BuildFactory.getInstance().create(HttpClient.class, HttpUtils.HOST_URL);
        }
     ...
     * 接口参数
     */
    @GET("back/api.php?app_id=1200000")
    Observable<VersionBean1> getHostURL();
